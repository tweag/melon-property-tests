...
module Melon.ABI.CanonicalPriceFeed where
...
abiOverview :: String
abiOverview = [abiFrom|../smart-contracts/out/pricefeeds/CanonicalPriceFeed.abi|]

-- Note the path is relative to the Haskell project root,
-- i.e. the directory containing the file @melon.cabal@.
[abiFrom|../smart-contracts/out/pricefeeds/CanonicalPriceFeed.abi|]
